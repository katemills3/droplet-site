...
if(isset($_POST)) {
	...
	$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 587, 'tls')
	  ->setUsername('katemills3@gmail.com')
	  ->setPassword('3543emerson')
	  ;
	...
	$message = Swift_Message::newInstance('An RSVP from your wedding website')
	  ->setFrom(array('katemills3@gmail.com' => 'RSVP'))
	  ->setTo(array('katemills3@gmail.com' => 'The Markat'))->setBody($messageText);
//                           ^                    ^
